...
public class AutodocMetaFacade {
	...
	public void marshal( AutodocMeta autodocMeta, OutputStream os ) throws Exception {
		this.marshal( autodocMeta, os, true, true );
	}
	
	public void marshal( AutodocMeta autodocMeta, OutputStream os, boolean format, boolean addSchemaLocation ) throws Exception {
	...
	public AutodocMeta unmarshal(InputStream is) throws Exception {
