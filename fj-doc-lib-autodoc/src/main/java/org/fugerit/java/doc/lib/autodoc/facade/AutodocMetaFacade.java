...
public class AutodocMetaFacade {
	...
	public static void marshal( AutodocMeta autodocMeta, OutputStream os ) throws DocException {
		marshal( autodocMeta, os, true, true );
	}
	
	public static void marshal( AutodocMeta autodocMeta, OutputStream os, boolean format, boolean addSchemaLocation ) throws DocException {
	...
	public static AutodocMeta unmarshal(InputStream is) throws DocException {
