...
dslDoc {
    meta {
        ...
        headerExt {
            ...
            para()
            phrase()
            table().width( 100 ).columns( 2 ).colwidths( "100" )
        }
        footerExt {
            h( "title 2" )
            para("test footer")
        ...
        bookmarkTree {
            ...
            bookmark()
            bookmark( "Bookmark 2" ).ref( "bookmark2" )
        }
    ...
    body {
        ...
        table {
            ...
            .spacing( 1 ).padding( 2 ).spaceAfter( 5 ).spaceBefore( 5 ).renderMode( "normal" ).caption( "test caption" )
