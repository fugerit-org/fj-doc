...
class TestConvertFacade {
    ...
    void testFacadeWrong4() throws ConfigException, IOException {
        Assertions.assertEquals(SAMPLE_JSON,
                facade.handleConvert(InputFacade.FORMAT_JSON, SAMPLE_JSON, InputFacade.FORMAT_JSON, false));
    }

    @Test
    void testFacadeWrong5() throws ConfigException, IOException {
        Assertions.assertEquals(SAMPLE_YAML,
                facade.handleConvert(InputFacade.FORMAT_YAML, SAMPLE_YAML, InputFacade.FORMAT_YAML, false));
    }

    @Test
    void testFacadeWrong6() throws ConfigException, IOException {
        Assertions.assertEquals(SAMPLE_XML,
                facade.handleConvert(InputFacade.FORMAT_XML, SAMPLE_XML, InputFacade.FORMAT_XML, false));
    }
