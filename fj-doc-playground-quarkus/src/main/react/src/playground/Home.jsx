...
import UIContext from "../common/ui-context"

const homepage = '/fj-doc-playground/home';

const cmdDockerRun = 'docker run -it --rm -p 8080:8080 --name fj-doc-playground-quarkus fugeritorg/fj-doc-playground-quarkus:snapshot';
