...
(*) link:#doc-format-entry-point[Fugerit Doc Format] is the core of the Venus Doc Framework and comes into a few flavours :

- link:#doc-format-entry-point-xml[XML], default
- link:#doc-format-entry-point-json-yaml[JSON] and link:#doc-format-entry-point-json-yaml[YAML] alternatives
- link:#doc-format-entry-point-kotlin[KOTLIN] Domain Specific Language
