...
- quarkus-version set to 3.37.1 across all modules
...
- quarkus-version set to 3.35.3 across all modules

### Fixed

- fj-doc-mod-fop - handling of id in fo:table-cell <https://github.com/fugerit-org/fj-doc/issues/652>

## [8.18.2] - 2026-04-26

### Changed

- fj-doc-playground-quarkus added flag -XX:+UseCompactObjectHeaders <https://openjdk.org/jeps/8361187>
...
- quarkus-version set to 3.30.1 across all the modules <https://github.com/fugerit-org/fj-doc/issues/585>
